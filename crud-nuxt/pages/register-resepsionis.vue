<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center p-4 py-8">
    ...
    <div class="relative w-full max-w-5xl bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden flex flex-col lg:flex-row">
      ...
      <div class="w-full lg:w-1/2 p-6 md:p-10">
        ...
        <div class="mb-8">
          <div class="flex items-center gap-3 mb-4">
            ...
            <div>
              <h2 class="text-2xl font-bold text-gray-800">Daftar sebagai Resepsionis</h2>
              <p class="text-xs text-yellow-600 font-medium">⏳ Menunggu verifikasi admin</p>
            </div>
          </div>
          <p class="text-gray-500 text-sm">Lengkapi data berikut untuk mendaftar sebagai resepsionis</p>
        </div>
        ...
        <form @submit.prevent="register" class="space-y-5">
          ...
          <div class="flex justify-center mb-6">
            <div class="relative group">
              <div class="w-32 h-32 rounded-full bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center overflow-hidden border-4 border-white shadow-lg ring-4 ring-blue-100 group-hover:ring-blue-300 transition-all duration-300">
                <img
              ...
              <label
                for="profile-upload"
                class="absolute bottom-0 right-0 w-10 h-10 bg-blue-600 hover:bg-blue-700 rounded-full flex items-center justify-center cursor-pointer shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-110"
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input
                  ...
                  required
                  placeholder="johndoe"
                  class="w-full pl-11 pr-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 outline-none transition-all duration-200 hover:border-gray-300"
                />
              </div>
            </div>
            <div>
          ...
          <div>
            ...
            <div class="relative">
              ...
              <textarea
                ...
                class="w-full pl-11 pr-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 outline-none transition-all duration-200 hover:border-gray-300 resize-none"
              ></textarea>
            </div>
          </div>
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input
                  ...
                  minlength="5"
                  placeholder="••••••••"
                  class="w-full pl-11 pr-10 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 outline-none transition-all duration-200 hover:border-gray-300"
                />
            ...
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <p class="text-xs text-yellow-700 mt-1">
                  Akun resepsionis memerlukan <strong>verifikasi admin</strong> sebelum dapat login. 
                  Anda akan mendapat notifikasi via email/WhatsApp setelah disetujui.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="pt-6">
            ...
            >
              ...
              <span v-else>🏨</span>
              {{ loading ? 'Memproses...' : 'Daftar sebagai Resepsionis' }}
            </button>
          </div>
          ...
          <div class="text-center pt-4 pb-2">
            <p class="text-sm text-gray-500">
              Sudah punya akun? 
              <button type="button" @click="goToLogin" class="text-blue-600 font-semibold hover:text-blue-800 hover:underline transition-colors">
                Login di sini →
              </button>
            </p>
          </div>
      ...
      <div class="hidden lg:flex w-1/2 bg-gradient-to-br from-blue-600 to-indigo-700 p-10 items-center justify-center relative overflow-hidden">
        ...
        <div class="relative z-10 text-center text-white max-w-sm">
          ...
          <h3 class="text-2xl font-bold mb-4">Resepsionis Hotel 🏨</h3>
          <p class="text-blue-100 text-sm leading-relaxed mb-6">
            Bergabung sebagai resepsionis untuk mengelola reservasi dan tamu. Akun memerlukan verifikasi admin.
          </p>
          ...
          <div class="space-y-3 text-left">
            <div class="flex items-center gap-3">
              ...
              <span class="text-sm text-blue-100">Verifikasi oleh admin</span>
            </div>
            <div class="flex items-center gap-3">
              <div class="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <span class="text-sm text-blue-100">Akses manajemen kamar</span>
            </div>
            <div class="flex items-center gap-3">
              <div class="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <span class="text-sm text-blue-100">Notifikasi saat disetujui</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div v-if="showPopup" class="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50" @click.self="closePopup">
      <div class="bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full text-center transform transition-all scale-100 hover:scale-[1.01]">
        <div class="relative w-24 h-24 mx-auto mb-6">
          ...
          <div class="relative w-full h-full bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center shadow-lg">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <h3 class="text-2xl font-bold text-gray-800 mb-3">📝 Pendaftaran Dikirim!</h3>
        <p class="text-gray-600 mb-8 leading-relaxed">
          Akun resepsionis Anda sedang dalam proses verifikasi. 
          Anda akan mendapat notifikasi via email/WhatsApp setelah disetujui admin.
        </p>
        
        <button @click="closePopup" class="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold py-3.5 px-8 rounded-xl transition-all duration-200 transform hover:scale-[1.02] shadow-lg hover:shadow-xl">
          ✓ Kembali ke Login
        </button>
...
const form = reactive({
  username: "",
  email: "",
  no_telp: "",  // ✅ WAJIB untuk resepsionis
  alamat: "",
  password: "",
  confirmPassword: "",
  level: "resepsionis", // ✅ HARDCODE: Resepsionis
  profileImage: null,
  imageFile: null
})
...
const register = async () => {
  if (!form.username || !form.email || !form.password || !form.alamat || !form.no_telp) {
  ...
  try {
    ...
    formData.append('no_telp', form.no_telp) // ✅ Wajib untuk resepsionis
    formData.append('alamat', form.alamat)
    formData.append('password', form.password)
    formData.append('password_confirmation', form.confirmPassword)
    formData.append('level', form.level) // ✅ Level sudah hardcoded: 'resepsionis'
...
input:focus, textarea:focus, select:focus { box-shadow: 0 0 0 4px rgba(59, 130, 246, 0.15); }
